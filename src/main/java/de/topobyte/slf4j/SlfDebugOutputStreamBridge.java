 ...
 * {@link Logger#debug(String) debug method}.
 * 
 * @author Sebastian Kuerten
 */
public class SlfDebugOutputStreamBridge extends SlfAbstractOutputStreamBridge
{

	public SlfDebugOutputStreamBridge(Logger logger)
	{
		super(logger);
	}
