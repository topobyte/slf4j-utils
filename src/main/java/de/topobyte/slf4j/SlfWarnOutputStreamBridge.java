 ...
 * {@link Logger#warn(String) warn method}.
 * 
 * @author Sebastian Kuerten
 */
public class SlfWarnOutputStreamBridge extends SlfAbstractOutputStreamBridge
{

	public SlfWarnOutputStreamBridge(Logger logger)
	{
		super(logger);
	}
